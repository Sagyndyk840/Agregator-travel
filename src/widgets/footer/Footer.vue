    ...
    <footer class="footer">
      <div class="container">
        <div class="footer-inner">
          ...
          <div class="footer-column">
            <h3 class="footer-column__title">Our Activities</h3>
          ...
          <div class="footer-column">
            <h3 class="footer-column__title">Travel Blogs</h3>
            <ul class="footer-column">
              <li>
